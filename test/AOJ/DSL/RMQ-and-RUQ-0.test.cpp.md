...
data:
  ...
  attributes:
    ...
    PROBLEM: http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_F&lang=ja
    links:
    - http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_F&lang=ja
  bundledCode: "#line 1 \"test/AOJ/DSL/RMQ-and-RUQ-0.test.cpp\"\n#define PROBLEM \"\
    http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_F&lang=ja\"\n#line\
    ...
    \ }\n};\n#line 3 \"test/AOJ/DSL/RMQ-and-RUQ-0.test.cpp\"\n\n#include<bits/stdc++.h>\n\
    using namespace std;\n\nint main() {\n    int n, q;\n    cin >> n >> q;\n    lazy_segment_tree<rminq_and_ruq>\
    \ lst(n);\n    for (int i = 0; i < q; i++) {\n        int com;\n        cin >>\
    \ com;\n        if (com == 0) {\n            int s, t, x;\n            cin >>\
    \ s >> t >> x;\n            lst.apply(s, t + 1, x);\n        } else if (com ==\
    \ 1) {\n            int s, t;\n            cin >> s >> t;\n            cout <<\
    \ lst.fold(s, t + 1) << endl;\n        }\n    }\n}\n"
  code: "#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_F&lang=ja\"\
  ...
  verifiedWith: []
documentation_of: test/AOJ/DSL/RMQ-and-RUQ-0.test.cpp
layout: document
redirect_from:
- /verify/test/AOJ/DSL/RMQ-and-RUQ-0.test.cpp
- /verify/test/AOJ/DSL/RMQ-and-RUQ-0.test.cpp.html
